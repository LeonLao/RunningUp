...
public class RoundImage extends ImageView{
    ...
    private  int defualtColor = 0xFFFFFFFF;
    //只有下面的其中一个值，则只画一个圆形边框
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        ...
        mBorderOutsideColor =a.
                getColor(R.styleable.roundedimageview_border_outside_color, defualtColor);
        mBorderInsideColor = a.getColor(
                R.styleable.roundedimageview_border_inside_color,defualtColor);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // }
        int radius = 0;
        if(mBorderInsideColor != defualtColor
                &&mBorderOutsideColor != defualtColor){
        ...
        }else if (mBorderInsideColor != defualtColor
                &&mBorderOutsideColor == defualtColor){
            //定义画一个边框
            radius = (defaultWidth<defaultHeight?
