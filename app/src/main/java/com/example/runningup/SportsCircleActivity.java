...
import com.example.runningup.adapter.ImageAdapter;
...
public class SportsCircleActivity extends Activity{
   ...
   //private MyAdapter adapter = new MyAdapter();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageAdapter = new ImageAdapter(SportsCircleActivity.this,width);

        //运动圈列表适配
        listView = (ListView)findViewById(R.id.circle_listView);
        listItemAdapter = new ListItemAdapter(SportsCircleActivity.this,imageAdapter);
